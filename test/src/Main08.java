...
public class Main08 
{
    ...
    private static int[][] fillArray(String myFile) 
    {
        ...
        /*
         * Note: You can also use the much shorter hand way of declaring and intialize a
         * 2D array by the following: int[][] result = new int[rows][cols]; They both do
         * the same thing logically and physically
         */
